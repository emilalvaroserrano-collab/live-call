(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      "#orbit-translator-panel{position:fixed;left:0;top:0;bottom:0;width:min(390px,94vw);z-index:10020;background:#171719;color:#f5f5f6;border-right:1px solid rgba(255,255,255,.13);box-shadow:12px 0 34px rgba(0,0,0,.38);display:flex;flex-direction:column;font-family:inherit}",
      "#orbit-translator-panel *{box-sizing:border-box}",
      "#orbit-translator-panel .oh{display:flex;align-items:center;justify-content:space-between;padding:13px 14px;border-bottom:1px solid rgba(255,255,255,.12);min-height:58px}",
      "#orbit-translator-panel .ot{font-size:15px;font-weight:750}",
      "#orbit-translator-panel button,#orbit-translator-panel select{font:inherit}",
      "#orbit-translator-panel .oc{width:34px;height:34px;border-radius:999px;border:1px solid rgba(255,255,255,.18);background:#242428;color:#fff;cursor:pointer}",
      "#orbit-translator-panel .ctl{padding:12px 14px;border-bottom:1px solid rgba(255,255,255,.1)}",
      "#orbit-translator-panel label{display:block;font-size:12px;font-weight:700;color:#c9c9ce;margin-bottom:7px}",
      "#orbit-translator-panel select{width:100%;height:42px;border:1px solid rgba(255,255,255,.18);border-radius:9px;background:#242428;color:#fff;padding:0 10px}",
      "#orbit-translator-panel .actions{display:flex;gap:8px;margin-top:10px}",
      "#orbit-translator-panel .primary,#orbit-translator-panel .secondary{height:42px;border-radius:9px;padding:0 14px;font-weight:700;cursor:pointer}",
      "#orbit-translator-panel .primary{flex:1;border:0;background:#f3f4f6;color:#101012}",
      "#orbit-translator-panel .primary.running{background:#b83434;color:#fff}",
      "#orbit-translator-panel .secondary{border:1px solid rgba(255,255,255,.17);background:#242428;color:#fff}",
      "#orbit-translator-panel .status{padding:9px 14px;border-bottom:1px solid rgba(255,255,255,.09);font-size:12.5px;color:#d0d0d5;min-height:39px}",
      "#orbit-translator-panel .error{margin:10px 12px 0;border:1px solid rgba(255,104,104,.35);background:rgba(160,35,35,.16);border-radius:9px;padding:9px 10px;color:#ffb2ad;font-size:12.5px}",
      "#orbit-translator-panel .scroll{flex:1;min-height:0;overflow:auto;padding:12px}",
      "#orbit-translator-panel .empty{border:1px dashed rgba(255,255,255,.16);border-radius:11px;padding:16px 13px;color:#aeb0b6;font-size:13px;line-height:1.45}",
      "#orbit-translator-panel .entry{border-bottom:1px solid rgba(255,255,255,.09);padding:11px 3px 13px}",
      "#orbit-translator-panel .meta{display:flex;gap:8px;align-items:center;justify-content:space-between;margin-bottom:6px}",
      "#orbit-translator-panel .speaker{font-size:13px;font-weight:750;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      "#orbit-translator-panel .badge{font-size:10px;color:#b6b7bd;border:1px solid rgba(255,255,255,.15);padding:3px 6px;border-radius:999px;text-transform:uppercase}",
      "#orbit-translator-panel .cap{font-size:10px;text-transform:uppercase;letter-spacing:.07em;color:#85878e;font-weight:750;margin:7px 0 3px}",
      "#orbit-translator-panel .original{font-size:13.5px;line-height:1.48;color:#bfc0c5;white-space:pre-wrap}",
      "#orbit-translator-panel .translated{font-size:13.5px;line-height:1.48;font-weight:550;white-space:pre-wrap}",
      "#orbit-donate-dialog{position:fixed;z-index:10030;left:50%;top:50%;transform:translate(-50%,-50%);width:min(390px,92vw);background:#171719;color:#fff;border:1px solid rgba(255,255,255,.16);border-radius:14px;box-shadow:0 24px 70px rgba(0,0,0,.5);padding:18px}",
      "#orbit-donate-dialog button{height:40px;border:0;border-radius:8px;padding:0 13px;cursor:pointer;font-weight:700}",
      "@media(min-width:800px){body.orbit-translator-open #react{margin-left:390px;width:calc(100% - 390px)!important}}"
    ].join("");
